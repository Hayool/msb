 ...
 */
 ...
 var options = {
    ...
    series: [{
        data: [5814832, 2200000, 8014832, 9200000]
    }],
    colors: ["#39afd1", "#39afd1", "#0acf97", "#ffbc00"],
    xaxis: {
		labels: {
			show: false,
		},
        ...
        categories: ['기존 미수금', '주문진행금액', '최종미수금', '여신한도'],
	},
	yaxis: {
		max: 9000000,
	},
...
var options = {
    ...
    xaxis: {
        categories: ['기존 미수금', '주문진행금액', '최종 미수금'],
    },
    yaxis: {
        labels: {
            show: false
